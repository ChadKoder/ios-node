...
angular.module('dash-client').directive('fileInput', ['$q', '$compile', '$timeout', function ($q, $compile, $timeout) {
	return {
		...
		template:[
			...
			'<md-card  md-ink-ripple layout="row" flex style="background: -webkit-linear-gradient(top, #545454, #929292); width: 95%; position: relative;">',
				'<label for="imageInput" style="width: 100%; font-size: 18pt; text-align: center; height: 100%; color: white;">',
					'Select Photos',
				'</label>',
			'</md-card>',
			'<md-card  md-ink-ripple layout="row" flex style="background: -webkit-linear-gradient(top, #545454, #929292); width: 95%; position: relative;">',
				'<label for="videoInput" style="width: 100%; font-size: 18pt; text-align: center; height: 100%; color: white;">',
					'Select Video',
				'</label>',
			'</md-card>',
