	...
	var DatabaseService = require('./output/js/functions/databaseService.js');
	var ResponseHandler = require('./output/js/functions/responseHandler.js');
	var Authentication = require('./output/js/functions/authentication.js');
	var Router = require('./output/js/functions/router.js');
	...
	var FileHandler = require('./output/js/functions/fileHandler.js');
	...
	var httpHandler = require('./output/js/functions/httpHandler')(router, responseHandler);
